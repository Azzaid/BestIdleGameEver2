...
export const selectEffectiveWallResolution = createSelector(
    ...
    (cityResolution, controlledTerritory): WallResolution => {
        ...
        return {
            ...
            pushBackDistance: toPixels(homogeneousValues[HOMOGENEOUS_VALUE_IDS.wallPushBackDistance] ?? 0),
            pushBacksPerSecond: homogeneousValues[HOMOGENEOUS_VALUE_IDS.wallPushBacksPerSecond] ?? 0,
            pushBackEffectZoneSize: toPixels(homogeneousValues[HOMOGENEOUS_VALUE_IDS.wallPushBackEffectZoneSize] ?? 0),
            ...
            zoneDotZoneSize: toPixels(homogeneousValues[HOMOGENEOUS_VALUE_IDS.wallZoneDotZoneSize] ?? 0),
