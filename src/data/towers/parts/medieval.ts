...
const medievalTowerPartsRaw: Record<string, GunPart> = {
  ...
  [gunparts.ammo.medieval.sharpenedStakes]: part(
    ...
    [gunparts.barrels.medieval.stoneRails]: part(
        gunparts.barrels.medieval.stoneRails,
        "barrel",
        "Stone rails",
        "Set of stone rails to guide projectile.",
        {
            projectileDamage: 7,
            weight: 5,
            projectileSpeed: 100,
    ...
    [gunparts.bases.medieval.stoneRails]: part(
        gunparts.bases.medieval.stoneRails,
        "platform",
        "Stone rails",
        "Set of stone rails to aid in tower rotation",
        {
            rotationSpeed: 0.45,
            projectileSpread: -0.1,
        },
    ...
    [gunparts.loadingSystems.medieval.counterweightLoader]: part(
        gunparts.loadingSystems.medieval.counterweightLoader,
        "loadingSystem",
