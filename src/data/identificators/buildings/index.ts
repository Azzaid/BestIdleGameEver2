...
3. Add or update unlock rules in src/data/content/rules.ts when the building is gated.
4. Add structure adjacency references in src/data/structures/index.ts when the building participates in a multistructure.
