...
export const HOMOGENEOUS_VALUE_DEFINITIONS = {
    ...
    [HOMOGENEOUS_VALUE_IDS.wallPushBackDistance]: {
        ...
        keywords: ["wall", "push", "pushBack", "distance", "display.distance"],
        initialValue: 0,
    },
    [HOMOGENEOUS_VALUE_IDS.wallPushBacksPerSecond]: {
        ...
        keywords: ["wall", "push", "pushBack", "rate", "display.default"],
        initialValue: 0,
    },
