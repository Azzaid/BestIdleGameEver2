...
export const DEFAULT_INITIAL_CITY_BIOME: CityBiome = CITY_BIOMES.plains;
...
export const TOWER_WEIGHT_ROTATION_PENALTY = 2;
...
export const BASE_TOWER_STATS = {
    ...
    singleTargetInfectionSlowPerStack: 0,
    singleTargetInfectionDamagePerSecond: 0,
    projectileInfectionDuration: 0,
    projectileInfectionStacks: 0,
    projectileInfectionMaxStacks: 0,
    projectileInfectionSlowPerStack: 0,
    projectileInfectionDamagePerSecond: 0,
    weight: 0,
    maximumWeight: 0,
};
