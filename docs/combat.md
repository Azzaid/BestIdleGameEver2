...
- The current trigger model uses city signature versus controlled territory: when effective signature exceeds controlled territory, the city becomes besieged. Siege pauses research and escalates battle pressure, but city building, demolition, tower rebuilding, migration, and wall-protected territory claims remain available.
