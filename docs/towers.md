...
- Tower part values resolve through the homogeneous value system into stats such as rotation speed, shots per second, burst count, damage, projectile speed/radius/spread, AOE radius, range limits, rotation limits, retarget cooldown, trigger tolerance, weight, and maximum supported weapon weight.
